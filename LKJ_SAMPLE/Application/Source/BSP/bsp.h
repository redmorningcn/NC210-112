...
extern u8   BSP_CPU_ClkFreq_MHz;      // 系统时钟频率（M）
/*
*********************************************************************************************************
...
#define  BSP_GPIO_LED01                          DEF_BIT_09
#define  BSP_GPIO_LED02                          DEF_BIT_09

#define  BSP_GPIO_LEDS                          (BSP_GPIO_LED01 | \
                                                 BSP_GPIO_LED02)
...
* 描述： 添加io品输入状态
*/  
#define GPIO_RD0_RCC                            RCC_APB2Periph_GPIOC
#define GPIO_RD0_PROT                           GPIOC
#define GPIO_RD0_PIN                            GPIO_Pin_6                      // 0：CSNC A2 / Modbus 2；1：CSNC A2 / Modbus 1

#define GPIO_RD1_RCC                            RCC_APB2Periph_GPIOA
#define GPIO_RD1_PROT                           GPIOA
#define GPIO_RD1_PIN                            GPIO_Pin_0                      // 0: 测量模块；1：显示模块

#define GPIO_RD2_RCC                            RCC_APB2Periph_GPIOA
#define GPIO_RD2_PROT                           GPIOA
#define GPIO_RD2_PIN                            GPIO_Pin_1                      // 0：双通道；1：单通道
...
#define      BSP_GPIO_High                BSP_LED_On
#define      BSP_GPIO_Low                 BSP_LED_Off
#define      BSP_GPIO_Toggle              BSP_LED_Toggle
#define      BSP_GPIO_Flash               BSP_LED_Flash
/*
*********************************************************************************************************
*                                              STATUS INPUTS
*********************************************************************************************************
