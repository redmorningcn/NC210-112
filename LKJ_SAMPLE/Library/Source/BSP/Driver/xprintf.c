...
//xprintfCOM1("%s", STM32F10x_STR);
//
//  xprintfCOM1(" WWW.ARMJISHU.COM use __STM32F10X_STDPERIPH_VERSION %d.%d.%d",
...
/*  xprintf("%d", 1234);            "1234"
    ...
    xprintf("%f", 10.0);            <xprintf lacks floating point support>
*/
void xprintfCOM1 (			/* Put a formatted string to the default device */
	const char*	fmt,	/* Pointer to the format string */
	...					/* Optional arguments */
)
{
...
//void xsprintfCOM1 (			/* Put a formatted string to the memory */
...
//void xfprintfCOM1 (					/* Put a formatted string to the specified device */
//	void(*func)(unsigned char),	/* Pointer to the output function */
//	const char*	fmt,			/* Pointer to the format string */
//	...							/* Optional arguments */
//)
