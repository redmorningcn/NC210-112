...
static void  OS_CPU_PendSVHandler (void);
...
__root  const  APP_INTVECT_ELEM  __vector_table[] @ ".intvec" = {
    ...
    BSP_IntHandlerTIM8_UP,                                           /* 60, INTISR[ 44]  USB Wakeup from Suspend EXTI Int.   */
    App_Reserved_ISR,                                           /* 61, INTISR[ 45]  USB Wakeup from Suspend EXTI Int.   */
    BSP_IntHandlerTIM8_CC,                                           /* 62, INTISR[ 46]  USB Wakeup from Suspend EXTI Int.   */
...
static  void  App_Fault_ISR (void)
{
    ...
    Ctrl.Para.dat.SysSts.udat.App_Fault_ISR = 1;
    Ctrl.Para.dat.SysSts.udat.FanMode       = Ctrl.Fan.Mode;
    Ctrl.Para.dat.SysSts.udat.FanLevel      = Ctrl.Fan.Level;
    BSP_FlashWriteBytes((u32) 126*2, (u8 *)&Ctrl.Para.dat.SysSts.udat, (u16) 1*2);
