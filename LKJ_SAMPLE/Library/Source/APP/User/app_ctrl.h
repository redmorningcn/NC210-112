...
#define COMM_EVT_FLAG_TIME_TICK		(1<<10)//时钟节拍
#define COMM_EVT_SAVE_DATA			(1<<11)//保存数据值flash中
...
/* app comm task queue event define */
//main board event
#define COMM_TASK_TIME_TICK				0x8000
#define COMM_TASK_START_COLLECTION		0x8001
#define COMM_TASK_COLLECT_BOARD_A		0x8002
#define COMM_TASK_COLLECT_BOARD_B		0x8003
#define COMM_TASK_COLLECT_BOARD_C		0x8004
#define COMM_TASK_COLLECT_COMPLETE		0x8005
#define COMM_TASK_BOARD_POLL_TIMEOUT	0x8006
#define COMM_TASK_CREATE_SAMPLE_TMR		0x8007

#define COMM_TASK_RX_COLLECTOR_INFO		0x8010
#define COMM_TASK_UPDATE_DETECT_INFO	0x8011

#define COMM_TASK_IAP_END					0x8080


/* app detect task queue event define */
#define DETECT_TASK_TIME_TICK				0x8100
#define DETECT_TASK_VOL_ADC_UPDATE		0x8101
#define DETECT_TASK_CALC_MAIN_SIGNAL		0x8102
/*
#define DETECT_TASK_CALC_CHA_FALL_TIME	0x8103
#define DETECT_TASK_CALC_CHA_RISE_TIME	0x8104
#define DETECT_TASK_CALC_CHB_FALL_TIME	0x8105
#define DETECT_TASK_CALC_CHB_RISE_TIME	0x8106
*/
#define DETECT_TASK_SAMPLE_CYCLE_TICK		0x8107
#define DETECT_TASK_CHECK_M1_CYCLE			0x8108
#define DETECT_TASK_CHECK_M2_CYCLE			0x8109
#define DETECT_TASK_M1_DATA_UPDATE			0x810a
#define DETECT_TASK_M2_DATA_UPDATE			0x810b
#define DETECT_TASK_ANALYZE_CAPTURE_DATA	0x810c
#define DETECT_CALC_DETECT_INFO				0x810d
#define DETECT_TASK_M1_HIGH_LEVEL_UPDATE	0x810e
#define DETECT_TASK_M1_LOW_LEVEL_UPDATE		0x810f
#define DETECT_TASK_M2_HIGH_LEVEL_UPDATE	0x8110
#define DETECT_TASK_M2_LOW_LEVEL_UPDATE		0x8111

/*mater task*/
#define MATER_TASK_RX_NMB_DATA			0x8200

/*mb task*/
#define MODBUS_TASK_RX_DATA				0x8300
 //sample board event

#define COMM_TASK_COLLECTION_INFO_UPDATE	0x9000
...
#define OS_EVT_SEN_UPDATE_PARA          0X00000040
