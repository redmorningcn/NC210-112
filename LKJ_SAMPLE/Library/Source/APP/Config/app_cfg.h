...
#define  APP_TASK_START_PRIO        (OS_CFG_PRIO_MAX - 15)  
#define  MB_OS_CFG_RX_TASK_PRIO     (OS_CFG_PRIO_MAX - 14)  // ModBus任务的优先级（没有用到ModBus则不需要关注）
#define  APP_TASK_WIFI_PRIO         (OS_CFG_PRIO_MAX - 13) 
#define  APP_TASK_COMM_PRIO         (OS_CFG_PRIO_MAX - 13)  
#define  APP_TASK_DTU_PRIO          (OS_CFG_PRIO_MAX - 13) 
#define  APP_TASK_SENSOR_PRIO       (OS_CFG_PRIO_MAX - 12)  
#define  APP_TASK_MATER_PRIO        (OS_CFG_PRIO_MAX - 12) 
#define  APP_TASK_BEEP_PRIO         (OS_CFG_PRIO_MAX - 11)  
#define  APP_TASK_KEY_PRIO          (OS_CFG_PRIO_MAX -  10)  
#define  APP_TASK_CONTROL_PRIO      (OS_CFG_PRIO_MAX -  9)  
#define	APP_TASK_DETECT_PRIO		(OS_CFG_PRIO_MAX - 8)	//由于ADC采样数据量大， 为保证其他任务运行DETECT 任务优先级设为最低
...
#define  APP_TASK_COMM_STK_SIZE                     64
#define  APP_TASK_DTU_STK_SIZE                      256u
#define  APP_TASK_SENSOR_STK_SIZE                   128u
#define  APP_TASK_MATER_STK_SIZE                    64u
#define  APP_TASK_KEY_STK_SIZE                      64u
#define	APP_TASK_DETECT_STK_SIZE			64u
#define  APP_TASK_CONTROL_STK_SIZE                  64u
#define  APP_TASK_BEEP_STK_SIZE                     64u
#define  APP_TASK_OSAL_STK_SIZE                     64u
